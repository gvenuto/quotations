...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $quotController->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $quotController->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="quotControllers form content">
            ...
            <fieldset>
                <legend><?= __('Edit Quot Controller') ?></legend>
                <?php
